...
$DBname = "yogesh";
 ...
 if($con)
 {
 	if(isset($_POST['calculate']))
	{
		...
		//FOR CN THEORY
		$present="SELECT SUM(Attendance) as Attendance1 FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject=`'HMI' AND Type='THEORY'";
		$result=mysqli_query($con,$present);
		$data=mysqli_fetch_array($result);
		
		$present1="SELECT SUM(Lecture) as 'Lecture' FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject='HMI' AND Type='THEORY'";
		$result1=mysqli_query($con,$present1);
		$data1=mysqli_fetch_array($result1);
		$Average1=($data['Attendance1']/$data1['Lecture'])*100;

		$present2="SELECT SUM(Attendance) as Attendance1 FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject='HMI' AND Type='PRACTICAL'";
		$result2=mysqli_query($con,$present2);
		$data2=mysqli_fetch_array($result2);
		
		$present3="SELECT SUM(Lecture) as 'Lecture' FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject='HMI' AND Type='PRACTICAL'";
		...
		$present4="SELECT SUM(Attendance) as 'Attendance1' FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject='DC' AND Type='THEORY'";
		$result4=mysqli_query($con,$present4);
		$data4=mysqli_fetch_array($result4);
		   //for Total number of lecture 
		$present5="SELECT SUM(Lecture) as 'Lecture' FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject='DC' AND Type='THEORY' ";
		...
		$present6="SELECT SUM(Attendance) as 'Attendance1' FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject='DC' AND Type='PRACTICAL'";
		$result6=mysqli_query($con,$present6);
		$data6=mysqli_fetch_array($result6);
		   //for Total number of lecture 
		$present7="SELECT SUM(Lecture) as 'Lecture' FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject='DC' AND Type='PRACTICAL'";
		$result7=mysqli_query($con,$present7);
		$data7=mysqli_fetch_array($result7);
		$Average4=($data6['Attendance1']/$data7['Lecture'])*100;
	

		$present10="SELECT SUM(Attendance) as 'Attendance1' FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject='CC' AND Type='PRACTICAL'";
		$result10=mysqli_query($con,$present10);
		$data10=mysqli_fetch_array($result10);
		   //for Total number of lecture 
		$present11="SELECT SUM(Lecture) as 'Lecture' FROM semVIII_AT WHERE Roll_no=$Roll_no AND subject='CC' AND Type='PRACTICAL' ";
		$result11=mysqli_query($con,$present11);
		$data11=mysqli_fetch_array($result11);
		$Average5=($data10['Attendance1']/$data11['Lecture'])*100;


		$sql = "CREATE TABLE IF NOT EXISTS AttendanceVIII(Roll_no INT(3),HMITH INT(3),HMIPR INT(3),DCTH INT(3),DCPR INT(3),CCPR INT(3))";
 		...
 		$sql = "SELECT * FROM AttendanceVII WHERE Roll_no='$Roll_no'";
	  	...
	  	{
		$sql9="INSERT INTO AttendanceVIII(Roll_no,HMITH,HMIPR,DCTH,DCPR,CCPR)VALUES('$Roll_no','$Average1','$Average2','$Average3','$Average4','$Average5')";
